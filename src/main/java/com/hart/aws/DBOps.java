...
//        String returnString = null;
//        ArrayList<Link> userList = new ArrayList<Link>();
//
...
//
//                User user2add = new User(users.getFirstName(), users.getLastName(), users.getEmail(), users.getAddress());
//                userList.add(user2add);
//            }
//        }
//        catch (Exception e) {
...
//                .withUpdateExpression("set info.rating = :r, info.plot=:p, info.actors=:a")
        ...
        try {
            ...
            System.err.println(e.getMessage());
            return "error 505 : ITEM NOT UPDATED";
        }
    }

    //DELETE ITEM.....
    public static String DeleteItem(String email, String lastName) throws Exception {
        BasicAWSCredentials credentials = new BasicAWSCredentials("AKIAJVWQTEYELFA6SWJA", "8ZNyh1AsicTX1D3ZZQN3INCHGm4EVmv34z0kvDEJ");
        AmazonDynamoDBClient client = new AmazonDynamoDBClient(credentials).withRegion(Regions.US_EAST_1);
        DynamoDB dynamoDB = new DynamoDB(client);
